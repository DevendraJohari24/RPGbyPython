...
hipotion = Item("Hi-Potion", "potion" , "Heals 100HP", 1000)
superpotion = Item("Super-Potion", "potion" , "Heals 500HP", 1000)
...
#INSTANTIATE PEOPLES
player_spells = [fire, thunder, blizzard, meteor, cura,cure,curaga]
...
while running:
      ...
      for enemy in enemies:
            ...
            if enemy_choice == 0:
                   ...
                   print( enemy.name.replace(" " , "")   + "attacks" + players[target].name.replace(" ", "" ) + "for " , enemy_dmg, "points of damages")
            elif enemy_choice == 1:
